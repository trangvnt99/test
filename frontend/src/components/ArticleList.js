...
export default function ArticleList() {
    ...
    const defaultThumbnail = "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=1000";
        ...
        <div className="esri-wrapper bg-white min-vh-100">
            ...
            <header className="esri-header-section py-5">
                <div className="esri-container">
                    <nav className="mb-2">
                        <span className="esri-breadcrumb">TRANG CHỦ / TIN TỨC & THÔNG BÁO</span>
                    </nav>
                                        ...
                                        <div className="col-md-7 p-4 d-flex flex-column justify-content-between">
                                            <div>
                                                <div className="esri-card-meta small mb-2">
                                                    <span className="text-dark fw-bold">{a.author || "admin"}</span>
                                                    <span className="mx-2">•</span>
                                                    <span>{new Date(a.created_at || a.create_at).toLocaleDateString('vi-VN')}</span>
                                                </div>
                                            ...
                                            <div className="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                                                <Link to={`/articles/${a.id}`} className="esri-link-detail">
