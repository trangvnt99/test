...
const InfoCard = ({ title, items, dark = false }) => (
  ...
  >
    <h2
      className={`text-3xl font-bold mb-6 ${dark ? "text-blue-400" : "text-slate-800"}`}
    >
      {title}
    </h2>
...
const GioiThieu = () => {
  ...
  const t = content[lang].about_page;
    ...
    <div className="min-h-screen bg-slate-50 font-sans antialiased text-slate-900 overflow-x-hidden">
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div
              className="space-y-6 text-lg text-slate-600 leading-relaxed text-justify"
              data-aos="fade-up"
            >
              {/* <p>
                Trung tâm DITAGIS là đơn vị tiên phong trong việc nghiên cứu và
                chuyển giao công nghệ về{" "}
                <strong>Hệ thống Thông tin Địa lý (GIS)</strong> tại Việt Nam.
              </p>
              <p>
                Với bề dày lịch sử gắn liền với trường Đại học Bách Khoa - ĐHQG
                TP.HCM, chúng tôi không ngừng đổi mới để mang lại những giải
                pháp quản lý tài nguyên và môi trường tối ưu nhất.
              </p> */}
              <p>{t.intro_p1}</p>
              <p>{t.intro_p2}</p>
            </div>
      ...
      <section className="bg-slate-50 py-20">
        <div className="container mx-auto px-6 lg:px-20">
          <InfoCard
            ...
            items={t.functions.items} // Map tự động từ mảng trong language.js
          />
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right">
              <h2 className="text-4xl font-bold mb-8 border-l-4 border-blue-500 pl-6">
                {/* Đội ngũ Nhân lực */}
                {t.human_res.title}
              </h2>
              <div className="space-y-6 text-slate-300 text-lg">
                {/* <p>
                  Hiện nay, DITAGIS quy tụ đội ngũ{" "}
                  <strong>26 chuyên gia</strong> trong đó có 02 Phó Giáo sư, 06
                  Tiến sĩ, 10 Thạc sĩ.
                </p>
                <p>Chúng tự hào có mạng lưới cộng tác viên quốc tế.</p> */}
                <p>{t.human_res.desc1}</p>
                <p>{t.human_res.desc2}</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-blue-50 overflow-hidden">
        <div className="container mx-auto px-6 lg:px-20 text-center max-w-4xl">
          ...
          <p
            className="text-lg text-slate-600 italic mb-10 leading-relaxed"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            {/* "Luôn nhận thức về trách nhiệm và vai trò của mình trong sự nghiệp
            phát triển của nhà Trường và của đất nước, Trung tâm DITAGIS dưới sự
            hướng dẫn của các nhà khoa học đầu ngành không ngừng nỗ lực phát
            triển đội ngũ nhân lực chất lượng cao trong lĩnh vực GIS và Môi
            trường cho Trung tâm và các cơ quan địa phương trong cả nước thông
            qua các hoạt động hợp tác nghiên cứu, đào tạo nhân lực, chuyển giao
            công nghệ và đặc biệt là học hỏi, giao lưu, hợp tác với các tổ chức
            khoa học cùng lĩnh vực trên thế giới. Với tinh thần đó, Trung tâm
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            ...
            >
              ...
              <p className="font-semibold text-blue-600">{t.vision.tech}</p>
            </div>
            <div
              className="bg-white p-6 rounded-xl shadow-sm flex-1"
              data-aos="flip-right"
            ...
            >
              ...
              <p className="font-semibold text-blue-600">{t.vision.training}</p>
            </div>
          </div>
        </div>
      </section>
