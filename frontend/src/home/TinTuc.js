        ...
        const fetchLatestArticles = async () => {
            try {
                ...
                if (Array.isArray(data)) {
                    ...
                    const publicArticles = data.filter(a => a.is_visible !== 0 && a.is_visible !== false);
        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 text-center items-center pr-20 pl-20 m-3 pb-12">
                ...
                {latestArticles.length === 0 ? (
                    <div className="col-span-3 text-gray-500 italic mt-5">Đang cập nhật tin tức...</div>
                ) : (
                    latestArticles.map((article) => (
                        <div key={article.id} className="hover:text-gray-800 w-10/12 mr-auto ml-auto h-full">
